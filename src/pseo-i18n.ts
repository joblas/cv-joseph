...
exifObj['Exif'][piexif.ExifIFD.UserComment] = userComment.toString('binary');`,
  ...
  .toFile(outputPath)`,
        ...
        onePhotoDemo: {
          ...
          variants: [
            { src: 'cambiar-pantalla-apple-iphone-14-pro.webp', altEs: 'Cambiar pantalla iPhone 14 Pro', altEn: 'iPhone 14 Pro screen replacement', width: 384, height: 256 },
            { src: 'cambiar-bateria-apple-iphone-14-pro.webp', altEs: 'Cambiar batería iPhone 14 Pro', altEn: 'iPhone 14 Pro battery replacement', width: 384, height: 256 },
            { src: 'cambiar-camara-trasera-apple-iphone-14-pro.webp', altEs: 'Cambiar cámara trasera iPhone 14 Pro', altEn: 'iPhone 14 Pro rear camera replacement', width: 384, height: 256 },
            { src: 'cambiar-puerto-carga-apple-iphone-14-pro.webp', altEs: 'Cambiar puerto de carga iPhone 14 Pro', altEn: 'iPhone 14 Pro charging port replacement', width: 384, height: 256 },
            { src: 'cambiar-tapa-trasera-apple-iphone-14-pro.webp', altEs: 'Cambiar tapa trasera iPhone 14 Pro', altEn: 'iPhone 14 Pro back cover replacement', width: 384, height: 256 },
            { src: 'cambiar-cristal-apple-iphone-14-pro.webp', altEs: 'Cambiar cristal iPhone 14 Pro', altEn: 'iPhone 14 Pro glass replacement', width: 384, height: 256 },
            { src: 'cambiar-altavoz-apple-iphone-14-pro.webp', altEs: 'Cambiar altavoz iPhone 14 Pro', altEn: 'iPhone 14 Pro speaker replacement', width: 384, height: 256 },
            { src: 'cambiar-microfono-apple-iphone-14-pro.webp', altEs: 'Cambiar micrófono iPhone 14 Pro', altEn: 'iPhone 14 Pro microphone replacement', width: 384, height: 256 },
            { src: 'cambiar-auricular-apple-iphone-14-pro.webp', altEs: 'Cambiar auricular iPhone 14 Pro', altEn: 'iPhone 14 Pro earpiece replacement', width: 384, height: 256 },
          ],
          caption: {
        ...
        crossDeviceDemo: {
          ...
          heroes: [
            { src: '/pseo/demo/apple-iphone-14-pro/reparar-apple-iphone-14-pro.webp', alt: 'iPhone 14 Pro — hero', width: 256, height: 256 },
            { src: '/pseo/demo/samsung-galaxy-s23-ultra/reparar-samsung-galaxy-s23-ultra.webp', alt: 'Samsung Galaxy S23 Ultra — hero', width: 256, height: 256 },
            { src: '/pseo/demo/reparar-xiaomi-12.webp', alt: 'Xiaomi 12 — hero', width: 256, height: 256 },
          ],
          comparison: [
            { src: '/pseo/demo/apple-iphone-14-pro/cambiar-pantalla-apple-iphone-14-pro.webp', alt: 'iPhone 14 Pro screen replacement', width: 384, height: 256 },
            { src: '/pseo/demo/samsung-galaxy-s23-ultra/cambiar-pantalla-samsung-galaxy-s23-ultra.webp', alt: 'Samsung Galaxy S23 Ultra screen replacement', width: 384, height: 256 },
          ],
          comparisonCaption: {
...
await pipeline
  ...
  .toFile(outputPath)`,
        ...
        demo: {
          ...
          frontal: [
            { src: '/pseo/before-after/iphone-14-pro-front-before.webp', alt: 'iPhone 14 Pro front — before repair', width: 400, height: 300 },
            { src: '/pseo/before-after/iphone-14-pro-front-after.webp', alt: 'iPhone 14 Pro front — after repair', width: 400, height: 300 },
          ],
          frontalCaption: 'iPhone 14 Pro — front before and after',
          trasera: [
            { src: '/pseo/before-after/iphone-14-pro-back-before.webp', alt: 'iPhone 14 Pro back — before repair', width: 400, height: 300 },
            { src: '/pseo/before-after/iphone-14-pro-back-after.webp', alt: 'iPhone 14 Pro back — after repair', width: 400, height: 300 },
          ],
        ...
        crossDeviceDemo: {
          ...
          samsung: [
            { src: '/pseo/before-after/samsung-a51-before.webp', alt: 'Samsung Galaxy A51 — before repair', width: 400, height: 300 },
            { src: '/pseo/before-after/samsung-a51-after.webp', alt: 'Samsung Galaxy A51 — after repair', width: 400, height: 300 },
          ],
          samsungCaption: 'Samsung Galaxy A51 — before and after',
          xiaomi: [
            { src: '/pseo/before-after/xiaomi-note9s-before.webp', alt: 'Xiaomi Redmi Note 9S — before repair', width: 400, height: 300 },
            { src: '/pseo/before-after/xiaomi-note9s-after.webp', alt: 'Xiaomi Redmi Note 9S — after repair', width: 400, height: 300 },
          ],
      ...
      items: [
        {
          ...
          a: 'Only if the pages add no unique value. Every page in this system contains real service data pulled directly from the production ERP: current pricing for both original and compatible parts with live stock status, estimated turnaround time calculated from historical repair completion data for that specific device and repair type, before/after photos taken during actual repairs in the shop, and verified customer reviews filtered by device family through a cascade system. The FAQ sections are generated from real questions customers asked about each repair type. The JSON-LD structured data includes genuine pricing and availability verified against the inventory database at build time. This is not AI-generated filler or templated placeholder content — it is production data that changes when the business data changes. Google rewards pages that answer the searcher\'s actual question with specific, verifiable information.',
        },
        {
          q: 'Does it only work in Seville?',
          a: 'The system uses a dual geographic strategy. Local pages follow the /reparar-{device}-{city} URL pattern and target Google\'s local pack, where proximity to the searcher is a strong ranking signal — these pages include the shop address, local reviews, and city-specific schema markup. National pages use the /cambiar-{part}-{brand}-{model} pattern with no geographic qualifier, targeting long-tail device-specific queries across all of Spain. Google treats these as informational rather than local intent, so they compete on content quality and domain authority instead of proximity. The URL structure matters because Google uses path segments as relevance signals. Each tier has its own sitemap, internal linking strategy, and DataForSEO volume thresholds. This dual approach means the same inventory data powers both local dominance in Seville and national visibility for niche repair queries that no competitor targets.',
        },
        {
          q: 'Why no AI-generated content?',
          a: 'Because the competitive moat is real, verifiable data that competitors cannot replicate with a language model. Prices come directly from the ERP inventory system and reflect actual supplier costs plus configured margins. Photos are from real repairs performed in the shop — before and after shots showing genuine work, not stock images. Reviews are from verified customers linked to actual work orders in the CRM. An AI-generated landing page might read well, but it contains no production data a searcher can trust or that Google can verify against structured data markup. The programmatic landing pages deliberately avoid generated prose for service content. The blog section did use AI assistance for long-form articles, paired with Google NotebookLM to generate a podcast episode per article — but that is editorial content, not service pages where data accuracy is critical.',
        },
        {
          q: 'Does Airtable scale with 4,700+ pages?',
          a: 'Yes, with caveats. The 14-table CMS with approximately 60 fields per table works reliably within a build pipeline that fetches data at build time rather than serving real-time queries. The Airtable API has rate limits of 5 requests per second per base, so the build script implements retry with exponential backoff and batches requests to stay within limits. Frequently accessed data like customer reviews and device family metadata is cached locally during the build to avoid redundant API calls. A full rebuild of all 4,730 pages takes approximately 15 minutes including API fetching, template rendering, and static file generation. For a system that rebuilds on data changes rather than serving dynamic pages, this is acceptable. If you needed real-time queries at scale — dynamic pricing or live inventory displays — evaluate Supabase or Postgres with connection pooling.',
        },
        {
          q: 'How do you keep pages updated?',
          a: 'When a technician updates a part price or adds a new device model in the ERP, the data syncs to the CMS base in Airtable via linked records and synced tables. The next build — triggered either manually or on a schedule — regenerates the affected landing pages with the updated pricing, stock status, and turnaround estimates. New customer reviews propagate automatically through the family-model cascade: a review for an iPhone 14 Pro screen repair appears on the model page, the iPhone 14 family page, and the general screen repair page. The review cascade uses Airtable rollup fields that aggregate reviews up the device hierarchy. DataForSEO keyword volumes are refreshed monthly to update indexation decisions. No manual content editing is needed — the system regenerates everything from the single source of truth in Airtable.',
        },
        {
          q: 'Why Astro instead of Next.js?',
          a: 'For a fully static site with 4,730 pages where content changes on rebuild rather than per request, Astro is the optimal choice. It ships pure HTML with zero JavaScript by default — only truly interactive components like the device search bar and the photo carousel use client-side JavaScript, loaded lazily via Astro\'s island architecture. This means each landing page loads in under one second on mobile with excellent Core Web Vitals scores out of the box: Largest Contentful Paint under 1.5 seconds, zero Cumulative Layout Shift, and sub-100ms First Input Delay. Next.js would add a JavaScript runtime to every page for features like client-side routing that a static content site does not need. Astro builds to flat HTML files that deploy to Cloudflare CDN with a single command, serving pages from edge nodes worldwide with no origin server latency.',
        },
        {
          q: 'What does DataForSEO do exactly?',
          a: 'DataForSEO provides real monthly search volume data for each keyword combination through their SERP and Keywords Data APIs. For every device plus repair type plus optional city combination, the build pipeline queries DataForSEO and stores the volume in Airtable\'s indexable boolean field. If a combination has zero or negligible search volume — for example, a niche repair for an obscure model in a small city — the page is still built for completeness but tagged with a noindex meta directive. This prevents Google from wasting crawl budget on pages nobody searches for, which would dilute the domain\'s overall authority. Pages that gain search volume in subsequent monthly refreshes get their noindex tag removed automatically. DataForSEO acts as the decision engine that separates the pages worth indexing from the ones that exist only for internal navigation and completeness.',
        },
      ],
    },
    resources: {
