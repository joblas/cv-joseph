const _en = {
    ...
    altSlug: 'av-career',
    seo: {
      title: 'Joe\'s Tech Solutions Seville | Phone Repair since 2009',
      description: 'The phone repair shop founded by Joseph in 2009 is still open in Seville, Spain. 30,000+ repairs. Find the shop or meet the founder.',
    },
    nav: {
      breadcrumbHome: 'Home',
      breadcrumbCurrent: 'Joe\'s Tech Solutions',
    },
    hero: {
