  ...
  return (
    <ArticleLayout lang={lang}>
      ...
      <article className="prose-custom">
        ...
        {/* Query examples */}
        <H3 id="query-examples">{'Real GSC queries'}</H3>
        <DataTable
          headers={['Query', 'Clicks', 'Imp.', 'CTR', 'Pos.']}
        ...
        <Photo1
          ...
          alt={'joestechsolutions.com homepage'}
          width={1406} height={1345}
          caption={'joestechsolutions.com: homepage generated with Astro SSG. Device search, categories and brands.'}
        />
        ...
        <DiagramZoom
          ...
          alt={'Airtable table hierarchy — programmatic SEO CMS'}
          width={800} height={418} hdWidth={2512} hdHeight={1312}
          caption={'The 14 CMS tables connected to the 12-base Business OS. 6-level hierarchy from device type to local variant.'}
        />
        ...
        <H3 id="cms-highlights">{'Key CMS patterns'}</H3>
        <CardStack
        ...
        <Photo1
          ...
          alt={'Samsung category page on joestechsolutions.com'}
          width={1440} height={900}
          caption={'Auto-generated category page. Each brand gets its own landing with models, pricing, and reviews.'}
        />
        ...
        <DiagramZoom
          ...
          alt={'Repair record fields in Airtable'}
          width={800} height={418} hdWidth={2512} hdHeight={1312}
          caption={'Each repair has ~60 fields: dual pricing, indexable flag, model specs that feed the dynamic copy.'}
        />
        ...
        <Photo1
          ...
          alt={'Repair page hero on joestechsolutions.com'}
          width={1440} height={900}
          caption={'Repair page hero: dual pricing (original/compatible), booking CTA, and semantic breadcrumb.'}
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <DiagramZoom
            ...
            alt={'Homepage search: "12 pro" shows results across all brands'}
            width={600} height={574} hdWidth={1406} hdHeight={1345}
            caption={'Home: "12 pro" → Xiaomi, Apple, Xiaomi...'}
          />
          <DiagramZoom
            src="/pseo/ss-buscador-iphone.webp"
            hdSrc="/pseo/ss-buscador-iphone-hd.webp"
            alt={'iPhone page search: "13" only shows iPhone models'}
            width={600} height={574} hdWidth={1406} hdHeight={1345}
            caption={'iPhone page: "13" → iPhones only'}
          />
        </div>
        ...
        <DiagramZoom
          ...
          alt={'Indexable field in Airtable driven by DataForSEO'}
          width={800} height={418} hdWidth={2512} hdHeight={1312}
          caption={'Decision engine: DataForSEO feeds the indexable field. No volume → noindex.'}
        />
        ...
        <DiagramZoom
          ...
          alt={'Image pipeline in Airtable'}
          width={800} height={418} hdWidth={2512} hdHeight={1312}
          caption={'Image pipeline: 1 GSM Arena photo → 18 auto-composited repair overlays. All synced with the Business OS.'}
        />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mb-6">
          {OVERLAY_HOVER.map((item, i) => (
            <OverlayCard
              ...
              hover={item.hover}
              model={item.model}
              alt={t.sections.imagePipeline.overlayShowcase.items[i].altEn}
            />
          ))}
        </div>
        ...
        <Photo2
          ...
          caption={t.sections.imagePipeline.crossDeviceDemo.comparisonCaption.en}
        />
        ...
        <ReviewCarousel alt={'CRO carousel with real reviews'} />
        ...
        <Photo1
          ...
          alt={'Growth curve in Google Search Console — clicks and impressions'}
          width={1178} height={294}
          caption={'Google Search Console: clicks (blue) and impressions (purple) from November 2024 through September 2025.'}
        />
        ...
        <Photo2
          items={[
            { src: '/pseo/ss-squarespace-mobile.webp', alt: 'joestechsolutions.com on Squarespace: mobile homepage', width: 800, height: 1422 },
            { src: '/pseo/ss-squarespace-pricing.webp', alt: 'joestechsolutions.com on Squarespace: pricing page with generic icons', width: 800, height: 1422 },
          ]}
          caption={'joestechsolutions.com on Squarespace. Homepage and pricing page: generic icons, no real photos, no ERP data.'}
        />
        ...
        <Photo1
          ...
          alt={'SISTRIX: organic visibility of joestechsolutions.com in constant decline from 2019 to 2024'}
          width={2000} height={1125}
          caption={'SISTRIX visibility index (2019-2024). 5-year declining trend, from 0.036 to 0.003.'}
        />

        <Photo2
          items={[
            { src: '/pseo/ss-audit-gsc-clicks.webp', alt: 'Google Search Console: organic clicks halving over 12 months', width: 2000, height: 1125 },
            { src: '/pseo/ss-audit-sector.webp', alt: 'SISTRIX: sector visibility comparison in Spain — joestechsolutions.com invisible vs competitors', width: 2000, height: 1125 },
          ]}
          caption={'Left: GSC shows clicks halving (17.3K clicks, avg position 23.1). Right: sector comparison — joestechsolutions.com is the red line stuck to the X axis.'}
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <DiagramZoom
            ...
            alt={'Screaming Frog: 838 pages with multiple H1s, 118 duplicates, 255 without H2'}
            width={2000} height={1125} hdWidth={3000} hdHeight={1688}
            caption={'Screaming Frog: 838 pages with multiple H1s'}
          />
          <DiagramZoom
            src="/pseo/ss-audit-images.webp"
            hdSrc="/pseo/ss-audit-images-hd.webp"
            alt={'Screaming Frog: 8,000+ images without size attributes, 497 too heavy, 164 without alt text'}
            width={2000} height={1125} hdWidth={3000} hdHeight={1688}
            caption={'Screaming Frog: 8,000+ images without dimensions'}
          />
        </div>
        ...
        <Photo1
          ...
          alt={'Repair page on Squarespace: generic icons and unstructured pricing'}
          width={1200} height={815}
          caption={'Typical repair page on Squarespace. Generic icons, no real photos, no JSON-LD, no ERP data.'}
        />

        <DiagramZoom
          src="/pseo/ss-audit-lighthouse.webp"
          hdSrc="/pseo/ss-audit-lighthouse-hd.webp"
          alt={'PageSpeed Insights: Lighthouse 21 on mobile, 51 on desktop. Core Web Vitals: Not passed across all page types'}
          width={2000} height={1125} hdWidth={3000} hdHeight={1688}
          caption={'Before: Squarespace. Lighthouse 21/100 mobile. CWV not passed.'}
        />
        <DiagramZoom
          src="/pseo/ss-audit-lighthouse-after.webp"
          hdSrc="/pseo/ss-audit-lighthouse-after-hd.webp"
          alt={'PageSpeed Insights: Lighthouse 97 on mobile, Accessibility 100, SEO 100. Core Web Vitals: Passed'}
          width={2512} height={1312} hdWidth={2512} hdHeight={1312}
          caption={<>After: Astro + Cloudflare. Lighthouse 97/100 mobile. CWV passed. <a href="https://pagespeed.web.dev/analysis/https-santiferirepair-es/rynn9cjrrs?form_factor=mobile" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Check it yourself →</a></>}
        />
        ...
        <DiagramZoom
          ...
          alt={'AHREFs sector comparison: joestechsolutions.com with DR 0.1 and 23 backlinks vs competitors with thousands'}
          width={2000} height={1125} hdWidth={3000} hdHeight={1688}
          caption={'Domain strength comparison (AHREFs). joestechsolutions.com: DR 0.1, 23 backlinks. Sector leader (iriparo.com): DR 44, 21,430 backlinks.'}
        />
        ...
        <CaseStudyCta
          heading={'The same ERP powers an AI agent'}
          body={'The Airtable data that generates these 4,700+ pages is also queried by Jacobo, an omnichannel AI agent that handles WhatsApp and phone. Same source of truth, two acquisition channels.'}
          ctaLabel={'Read Jacobo case study →'}
        ...
        <CaseStudyCta
          ...
          ctaHref="mailto:hola@cv-joseph.vercel.app?subject=Programmatic SEO"
        />
