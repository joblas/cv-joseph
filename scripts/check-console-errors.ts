 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://cloudyjoe.com
 *
...
function getUrls(): string[] {
  ...
  urls.push('https://cloudyjoe.com/privacidad', 'https://cloudyjoe.com/privacy')

  // Convert to use the base URL
  return urls.map(url => url.replace('https://cloudyjoe.com', baseUrl))
}
