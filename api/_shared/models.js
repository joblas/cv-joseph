...
export const FAST_MODEL = process.env.CHAT_MODEL_FAST || 'claude-haiku-4-5-20251001'
...
export const CHAT_MAX_TOKENS = Number(process.env.CHAT_MAX_TOKENS) || 800

export function createAnthropicClient() {
  return new Anthropic({
    apiKey: process.env.ANTHROPIC_API_KEY || undefined,
    // Bearer auth (ANTHROPIC_AUTH_TOKEN) is what Ollama Cloud expects; the SDK
    // sends x-api-key for apiKey and Authorization for authToken.
